    ...
    >
      ...
      <div className="relative container pl-14 mx-auto px-5 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-16">
          <Link to='/toko-buku' className="text-white text-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
